...
\begin{table}[ht!]
  \begin{tabular}{|p{0.3\textwidth}|p{0.3\textwidth}|p{0.3\textwidth}|}
    ...
    \hline
    Final Report                   & PDF file & Uploaded to Minerva (12/08/26) \\
    \hline
    Link to online code repository & URL      & Sent to supervisor and assessor (12/08/26) \\
    \hline
  \end{tabular}
\end{table}
...
\noindent The candidate confirms that the work submitted is their own
and the appropriate credit has been given where reference has been
made to the work of others.

\vfill

\noindent I understand that failure to attribute material which is
obtained from another source may be considered as plagiarism.
...
\flushright(Signature of Student) Matthew Alwan
\flushleft
